...
func newMainnetGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			...
			common.HexToAddress("0xad8c6c5c0ea5aa5c34c91f731667cca295fca81f"): {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Cpc))},
			// bank 22
			common.HexToAddress("0x90e5a4d05bbe6ec0b158066075b2ef2219acdb3c"): {Balance: new(big.Int).Mul(big.NewInt(873880028800), big.NewInt(configs.Finney))},
		},
		Dpor: types.DporSnap{
			Proposers:  configs.Proposers(),
			Seal:       types.DporSignature{},
